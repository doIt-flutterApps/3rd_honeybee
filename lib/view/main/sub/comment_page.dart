...
class _CommentPage extends State<CommentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(user.hobby!)),
      body: FutureBuilder(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      widget.selectedPost['user'],
                      style: TextStyle(fontSize: 12),
                    ),
                    SizedBox(height: 10),
                    Text(
                      widget.selectedPost['timestamp']
                          .toDate()
                          .toString()
                          .substring(0, 16),
                    ...
                    widget.selectedPost['image'] != ''
                        ? SizedBox(
                          height: 200,
                          child: Image.network(widget.selectedPost['image']),
                        )
                        : Container(),
                  ],
                ),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        HoneyBeeUser user = Get.find();
                        final content =
                            _commentEditingController.text.toString();
                        if (content.isEmpty) {
                          return;
                        }
                        final comment = {
